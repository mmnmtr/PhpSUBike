...
<body>
        <?php
         ...
         $result = $mysqli->query("SELECT * FROM Station") or die(mysqli_error($mysqli));
        //  pre_r($result);
      ...
      <article class="database">
        <div class="container">
          <div class="row">
            ...
            <div class="d-block mx-auto">
                <div class="menu">
                    <a href="viewBike.php" class="active target btn btn-menu ">BICYCLE</a>
                </div>
            </div>
            ...
            <div class="container h-100">
              ...
              <div class="col-md-8 offset-md-2">
                <label class="show-title">SHOWSTATION</label>
                <table class="demotbl">
                  <tr>
                    <th width="240px;">รหัสสถานี</th>
                    <th width="240px;">ชื่อชื่อสถานี</th>
                    <th>จำนวนจักรยาน</th>
                  ...
                  <?php while ($row = $result->fetch_assoc()):?>
                    <tr>
                      ...
                      <td><?php echo $row['Statinn_NumB']; ?></td>
