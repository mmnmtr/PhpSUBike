      ...
      <article class="database">
        <div class="container">
          <div class="row">
            ...
            <div class="d-block mx-auto">
              <div class="menu">
                <a href="registerMember.php" class="target btn btn-menu ">MEMBER</a>
              </div>
              <div class="menu">
            ...
            <div class="container h-100">
              <div class="row align-items-center">
                <form action="processBike.php" method='POST'>  

                  <div class="row">
                    <div class="col col-12 col-md-4 offset-md-2">
                      <div class="form-group">
                        <label for="formGroupExampleInput">รหัสจักรยาน</label>
                        <input type="text" class="form-control" name="Bike_Id"  value="<?php echo $Bike_Id;?>" placeholder="">
                      </div>
                    </div>
                    ...
                    <div class="col col-12 col-md-4">
                      <div class="form-group">
                        ...
                        <select name="Bike_Status" id="" class="form-control">
                          <option value="<?php echo $Bike_Status='ว่าง'; ?>">ว่าง</option>
                          <option value="<?php echo $Bike_Status='กำลังใช้งาน'; ?>">กำลังใช้งาน</option>
                          <option value="<?php echo $Bike_Status='ซ่อมแซม'; ?>">ซ่อมแซม</option>
                        </select>
                      </div>
                    </div>
                    <div class="col col-12 col-md-4">
                      <div class="form-group">
                        <label for="formGroupExampleInput">วันที่ยืม</label>
                       
                        <input id="datepicker" name="Bike_LoanDate"  value="<?php echo $Bike_LoanDate;?>"/>
                      </div>
                    </div>
            
                    <div class="col col-12 col-md-4">
                      <div class="form-group">
                        <label for="formGroupExampleInput">วันที่คืน</label>
                       
                        <input id="datepicker2" name="Bike_ReturnedDate"  value="<?php echo $Bike_ReturnedDate;?>"/>
                      </div>
                    </div>
                    ...
                    <div class="col col-12 col-md-4">
                      <div class="form-group">
                        <label for="formGroupExampleInput">นาที</label>
                        <input type="text" class="form-control" name="Bike_Time"  value="<?php echo $Bike_Time;?>" placeholder="">
                      </div>
                    </div>
                  ...
                  <div class="row justify-content-end">
                    <div class="menu2">
                      <a href="viewBike.php" class="target btn btn-do ">VIEW</a>
                    </div>
