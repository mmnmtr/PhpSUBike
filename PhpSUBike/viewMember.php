...
<body>
        <?php
         ...
         $result = $mysqli->query("SELECT Member.student_Id,Member.student_FName,Member.student_LName,Faculty.Faculty_name,Member.student_Grade,Member.Card_ID,Member.student_phone 
         FROM Faculty JOIN Member
         on 		Faculty.Faculty_Id = Member.Faculty_Id
         ORDER BY Member.Card_ID ASC"
      ...
      <article class="database">
        <div class="container">
          <div class="row">
            ...
            <div class="d-block mx-auto">
                <div class="menu">
                    <a href="registerBike.php" class="active target btn btn-menu ">MEMBER</a>
                </div>
            </div>
            ...
            <div class="container h-100">
              <div class="row align-items-center">
                ...
                <label class="show-title">SHOWMEMBER</label>
                <table class="demotbl">
                  <tr>
                  ...
                  <?php while ($row = $result->fetch_assoc()):?>
                    <tr>
                      ...
                      <td><a href="MemberCard.php" style="color: #398a6a;"><?php echo $row['Card_ID']; ?></a></td>
                      ...
                      <td>
                          <a href="registerMember.php?edit=<?php echo $row['student_Id'];?>" class=" btn btn-edit" >Edit</a>
                      </td>
                      <td>
                          <a href="process.php?delete=<?php echo $row['student_Id'];?>" class=" btn btn-delete" >Delete</a>
                      </td>
                    </tr>
                  <?php endwhile; ?>
                </table>
          ...
          <div class="row justify-content-end">
            <a href="registerMember.php" class="target btn btn-do ">INSERT</a> 
          </div>
        </div>
      </article>
